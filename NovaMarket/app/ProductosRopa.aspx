<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductosRopa.aspx.cs" Inherits="NovaMarket.app.ProductosRopa" %>
...
<body>
    <form runat="server">
        ...
        <section class="products">
            <h1 class="tecnotitle" style="margin-bottom: 7%; margin-left: 0%; color: #fff; font-size: 300%; text-align: center; border-color: black; background-color: #3a78ae; border-radius: 9px">Ropa</h1>
             <div>
                ...
                <asp:DropDownList ID="drop"   CssClass="form-control" Width="200" runat="server" AppendDataBoundItems="True" AutoPostBack="False"></asp:DropDownList>
                </br>
