<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditarProductos.aspx.cs" Inherits="NovaMarket.app.EditarProductos" %>
...
<body>
    <form runat="server">
        ...
        <section class="products">
            <h1 class="tecnotitle" style="margin-bottom: 7%; margin-left: 0%; color: #fff; font-size: 300%; text-align: center; border-color: black; background-color: #3a78ae; border-radius: 9px">Editar Productos</h1>
            ...
            <div>
                <asp:Button ID="btnRegistrar" class="btn btn-primary" runat="server" Text="Editar" OnClick="btnRegistrar_Click" />
            </div>
        </section>
    </form>
